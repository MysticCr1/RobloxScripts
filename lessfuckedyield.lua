...
COREGUI = game:GetService("CoreGui")Players = game:GetService("Players")UserInputService = game:GetService("UserInputService")TweenService = game:GetService("TweenService")HttpService = game:GetService("HttpService")MarketplaceService = game:GetService("MarketplaceService")RunService = game:GetService("RunService")TeleportService = game:GetService("TeleportService")StarterGui = game:GetService("StarterGui")GuiService = game:GetService("GuiService")Lighting = game:GetService("Lighting")ContextActionService = game:GetService("ContextActionService")ReplicatedStorage = game:GetService("ReplicatedStorage")GroupService = game:GetService("GroupService")PathService = game:GetService("PathfindingService")SoundService = game:GetService("SoundService")Teams = game:GetService("Teams")StarterPlayer = game:GetService("StarterPlayer")InsertService = game:GetService("InsertService")ChatService = game:GetService("Chat")ProximityPromptService = game:GetService("ProximityPromptService")ContentProvider = game:GetService("ContentProvider")StatsService = game:GetService("Stats")MaterialService = game:GetService("MaterialService")AvatarEditorService = game:GetService("AvatarEditorService")TextService = game:GetService("TextService")TextChatService = game:GetService("TextChatService")CaptureService = game:GetService("CaptureService")VoiceChatService = game:GetService("VoiceChatService")
IYMouse = Players.LocalPlayer:GetMouse()PlayerGui = Players.LocalPlayer:FindFirstChildWhichIsA("PlayerGui")PlaceId, JobId = game.PlaceId, game.JobId
...
addcmd('antiafk',{'antiidle'},function(args, speaker)
	...
	if GC then
		...
		local VirtualUser = game:GetService("VirtualUser")		Players.LocalPlayer.Idled:Connect(function()
...
addcmd("datalimit", {}, function(args, speaker)
    ...
    if kbps then
        local NetworkClient = game:GetService("NetworkClient")        NetworkClient:SetOutgoingKBPSLimit(kbps)
    end
end)
